...
| `html` | Ship production HTML/CSS from a prose or image mockup using reflow-native rules and Phase 5 F-14 anti-AI-slop guards. Emits to `docs/design/{slug}/`. | M-13 (F-23) |
